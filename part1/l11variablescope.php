...
function funone(){
    echo "Global Variable print in function = $num1";  // Error: Undefined variable $num1
}
funone(); // Global Variable print in function = (no print $num1 , cuz function will generate an error)

echo "Global Variable print outside = $num1"; // Global Variable print outside function = 100
...
echo "Local Variable print outside = $num2"; // Local Variable print in function = (no print $num1 , cuz function will generate an error)
...
=> Super Global Variable
    ...
    function funfour(){
        ...
        echo "This is result , print by funfour = $sum"; // undefined variable $sum
    }
    funfour();
